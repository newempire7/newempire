...
const ChangFlow = () => {
  ...
  const handleLandChange = <K extends NumericKeys<LandCostInputs>>(key: K) => (value: number) => {
    setInputs((prev) => ({
      ...prev,
      land: {
        ...prev.land,
  ...
  const handleConstructionChange = <K extends NumericKeys<ConstructionInputs>>(key: K) => (value: number) => {
    setInputs((prev) => ({
      ...prev,
      construction: {
        ...prev.construction,
  ...
  const handleMarketingChange = <K extends NumericKeys<MarketingInputs>>(key: K) => (value: number) => {
    setInputs((prev) => ({
      ...prev,
      marketing: {
        ...prev.marketing,
  ...
  const handleFinanceChange = <K extends NumericKeys<FinanceInputs>>(key: K) => (value: number) => {
    setInputs((prev) => ({
      ...prev,
      finance: {
        ...prev.finance,
  ...
  const handleSalesChange = <K extends NumericKeys<SalesInputs>>(key: K) => (value: number) => {
    setInputs((prev) => ({
      ...prev,
      sales: {
        ...prev.sales,
        ...
        <KpiCard>
          ...
          <span className="value">
            {Number.isFinite(result.project.equityIrr)
              ? formatPercent(result.project.equityIrr, 2)
              : "-"}
          </span>
        </KpiCard>
        <KpiCard>
